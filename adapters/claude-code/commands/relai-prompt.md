...
argument-hint: "[--model <nazwa>] [--dla <nazwa>] [tekst do przerobienia] albo on / off [--globalnie] — np. /relai-prompt --model opus popraw walidację w formularzu logowania, bo się sypie"
---
