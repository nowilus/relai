...
**Ta komenda pochodzi z RelAI 1.9.0** — ta liczba to wersja docelowa aktualizacji. Komenda jest
...
| Obszar | Stan docelowy 1.9.0 | Jak sprawdzasz |
|---|---|---|
...
| marker wersji | `Wersja RelAI: 1.9.0` | zmiana **na końcu**, po wykonaniu zatwierdzonych zmian |
...
2. Propozycja commita: `chore: update RelAI project to 1.9.0`. Commit wyłącznie za zgodą.
