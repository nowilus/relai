...
**Ta komenda pochodzi z RelAI 2.3.1** — ta liczba to wersja docelowa aktualizacji. Komenda jest
...
| Obszar | Stan docelowy 2.3.1 | Jak sprawdzasz |
|---|---|---|
...
| marker wersji | `Wersja RelAI: 2.3.1` | zmiana **na końcu**, po wykonaniu zatwierdzonych zmian |
...
2. Propozycja commita: `chore: update RelAI project to 2.3.1`. Commit wyłącznie za zgodą.
