...
Wersja 1.8.1 (odnoga GUARD_PO_SCIEZCE — procedura skilla bez zmian; podniesiony wyłącznie marker wersji wymagany w `docs/USTAWIENIA.md`). Wersja 1.8.0: plan SPRZATANIE_ARTEFAKTOW — sprzątanie artefaktów roboczych: zdanie na starcie sesji ponad progiem i krok 2a rytuału zamknięcia dnia. Zakres tego skilla: **rozpoznanie stanu folderu + inicjalizacja + tryb
...
- `docs/USTAWIENIA.md` **musi** zawierać linię `Wersja RelAI: 1.8.1` — to marker, po którym RelAI
