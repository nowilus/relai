...
Wersja 1.6.1 (E5 planu OPTYMALIZACJA_KONTEKSTU — budżet startu i rotacja na starcie). Zakres tego skilla: **rozpoznanie stanu folderu + inicjalizacja + tryb
...
- `docs/USTAWIENIA.md` **musi** zawierać linię `Wersja RelAI: 1.6.1` — to marker, po którym RelAI
