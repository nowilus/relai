...
**Ta komenda pochodzi z RelAI 2.1.3** — ta liczba to wersja docelowa aktualizacji. Komenda jest
...
| Obszar | Stan docelowy 2.1.3 | Jak sprawdzasz |
|---|---|---|
...
| marker wersji | `Wersja RelAI: 2.1.3` | zmiana **na końcu**, po wykonaniu zatwierdzonych zmian |
...
2. Propozycja commita: `chore: update RelAI project to 2.1.3`. Commit wyłącznie za zgodą.
