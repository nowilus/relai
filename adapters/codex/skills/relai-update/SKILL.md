...
**Ta komenda pochodzi z RelAI 2.5.0** — ta liczba to wersja docelowa aktualizacji. Komenda jest
...
| Obszar | Stan docelowy 2.5.0 | Jak sprawdzasz |
|---|---|---|
...
| marker wersji | `Wersja RelAI: 2.5.0` | zmiana **na końcu**, po wykonaniu zatwierdzonych zmian |
...
2. Propozycja commita: `chore: update RelAI project to 2.5.0`. Commit wyłącznie za zgodą.
