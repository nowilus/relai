...
function sourceFiles() {
  ...
  if (commands.length !== 12) throw new Error('Oczekiwano 12 komend RelAI, znaleziono: ' + commands.length);
...
if (require.main === module) {
  ...
  process.stdout.write('RelAI Codex skills: 12 procedur + 2 skille rdzeniowe, spojne.\n');
}
