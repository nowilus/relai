# ARCHIWUM LEKCJI — budowa RelAI · L-0025 … L-0054

Rotacja: 2026-09-01 · Plik źródłowy: `docs/LEKCJE.md` (sekcja „Lekcje zwinięte") · Przeniesionych lekcji: 30 · Suma kontrolna: `d7c16fc38575773e`

Treść poniżej separatora jest kopią **bajt w bajt** z żywego pliku. Nic nie zostało streszczone,
skrócone ani poprawione. Statusy `ZWINIĘTA` pochodzą z kompresji z 2026-08-20 — destylaty tych
lekcji żyją dalej w sekcji „Zasady aktywne" pliku `docs/LEKCJE.md`.
