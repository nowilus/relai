...
|---|---|---|---|---|
| E1 | Fundament repo pluginu + inicjalizacja projektu | **GOTOWY DO STARTU** | [PROMPT_ETAP_1.md](PROMPT_ETAP_1.md) | świeża sesja na Opusie |
| E2 | Rdzeń dokumentacyjny (specyfikacje dokumentów + rytuały) | OCZEKUJE | — | |
