...
| E3 | Prewencja w etapach i odnogach | **GOTOWY DO STARTU** | [PROMPT_ETAP_3.md](PROMPT_ETAP_3.md) | `SPEC_PROMPT_ETAPU.md` (linie 129 i 255 przestają być martwe), `SPEC_ODNOGA.md`, skill i reguła planowania, `/relai-stage`, `/relai-branch` |
