...
| E4 | Pomiar na realnych projektach i wydanie 1.8.0 | **W TOKU** | [PROMPT_ETAP_4.md](PROMPT_ETAP_4.md) | KOMENDY, README + ikona `clean.svg`, `relai-update.md`, ARTEFAKTY, sekwencja P-005; pomiar na RelAI i PolyFlow; **ostatni etap planu** — rytuał kończy się sekwencją zamknięcia planu (D-36) |
