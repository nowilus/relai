...
| E2 | Rozbrojenie rotacji | **GOTOWY DO STARTU** | [PROMPT_ETAP_2.md](PROMPT_ETAP_2.md) | sekcja „Czeka na człowieka", blokada liczona tylko z niej, rotacja także na starcie |
| E3 | STATE i CLAUDE pod budżetem | OCZEKUJE | — | twardy kształt `STATE.md`, budżet `CLAUDE.md`, nowa `SPEC_PULAPKI` |
| E4 | Ryzyka, ustawienia, status planu | OCZEKUJE | — | stan bieżący zamiast historii; po tym etapie wydanie 1.6.0 |
