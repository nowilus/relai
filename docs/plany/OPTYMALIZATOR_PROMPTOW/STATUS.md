...
|---|---|---|---|---|
| E1 | Baza reguł i komenda | **GOTOWY DO STARTU** | [PROMPT_ETAP_1.md](PROMPT_ETAP_1.md) | Port merytoryki `nidhinjs/prompt-master` (MIT) do `core/prompt/`, komenda w adapterze Claude Code, **nota licencyjna w tym samym commicie** co pierwszy portowany plik. Działa na modelu sesji — wybór modelu rozstrzyga E2 |
| E2 | Pomiar modeli | OCZEKUJE | — | Ten sam zestaw surowych zdań przez Haiku 4.5, Sonneta 5 i Opusa 5; instrument liczy **pokrycie dziewięciu wymiarów i koszt jednego przerobienia**, osobno z blokiem kontekstu i bez niego (cena utraconego cache'u). Wynik ustala rekomendację w wierszu `Model optymalizatora` |
