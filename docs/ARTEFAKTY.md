...
## Agenci załogi — `adapters/claude-code/agents/` (3)

Subagenci pluginu Claude Code używani wyłącznie przez `/relai-crew`. Adapter Cursora **nie ma
...
| Agent `relai-reviewer` | `adapters/claude-code/agents/relai-reviewer.md` | 1 | 2026-09-06 | nowy artefakt: rola REVIEWER — narzędzia tylko-do-odczytu, znaleziska z plikiem i linią, werdykt APPROVE / WARN / BLOCK | Przegląd bez werdyktu nie zamyka przebiegu; recenzent z prawem zapisu przestaje być recenzentem |
