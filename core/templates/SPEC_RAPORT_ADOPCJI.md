...
Adopcja: 2026-08-09 · RelAI 1.7.0 · Wykonawca: RelAI (Opus) + Lukasz
...
| `docs/USTAWIENIA.md` | marker `Wersja RelAI: 1.7.0` + wykryte: język polski, profil `app` |
| `docs/KOMENDY.md` | ściąga komend wersji 1.7.0 |
