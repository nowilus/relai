...
7. Aktywny plan — linia niżej w sekcji „Stan prac"; obecnie: **SPRZATANIE_ARTEFAKTOW** (E4 gotowy do startu — ostatni etap planu).
...
| Co | Status | Gdzie |
|---|---|---|
| Plugin RelAI — wydany, dwa adaptery | DZIAŁA (1.8.0 w repo) | [docs/STATE.md](docs/STATE.md) |
...
| Plan SPRZATANIE_ARTEFAKTOW — 4 etapy | **3/4** — E1–E3 ZREALIZOWANE 2026-09-03, E4 gotowy (ostatni) | [STATUS](docs/plany/SPRZATANIE_ARTEFAKTOW/STATUS.md) |
